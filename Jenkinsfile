pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/Rimalgp/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('rimalgp-225')   // <---- Change this to match your kubernetes cluster credentials
    }
